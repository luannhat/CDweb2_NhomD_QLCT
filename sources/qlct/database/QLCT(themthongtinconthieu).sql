...
CREATE TABLE `NGANSACH` (
  ...
  `machitieu` int NOT NULL,
  `ngay` date NOT NULL,
  `tiennha` decimal(18,2) DEFAULT 0,
  `anuong` decimal(18,2) DEFAULT 0,
  `dilai` decimal(18,2) DEFAULT 0,
  `muasam` decimal(18,2) DEFAULT 0,
  `ngansach` decimal(18,2) GENERATED ALWAYS AS (`tiennha` + `anuong` + `dilai` + `muasam`) STORED,
