...
class ForgotPasswordController {
    ...
    public function handleForgotPassword() {
        ...
        if (!empty($errors)) {
            header('Location: ../views/Forgot_password.php?error=' . urlencode(implode(', ', $errors)));
            exit;
        }
        ...
        try {
            ...
            header('Location: ../views/Forgot_password.php?error=Có lỗi xảy ra, vui lòng thử lại');
            exit;
        }
    }
